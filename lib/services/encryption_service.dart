...
class EncryptionService {
  ...
  static ({Uint8List ciphertext, Uint8List iv, Uint8List tag}) _doEncrypt(Uint8List plaintext, String passphrase) {
  ...
  static Uint8List _doDecrypt(Uint8List ciphertext, Uint8List iv, Uint8List tag, String passphrase) {
    final keyBytes = _deriveKey(passphrase);
  ...
  static Uint8List encryptToEnc(String text, String passphrase) {
    ...
    final result = _doEncrypt(plaintext, passphrase);
  ...
  static String decryptFromEnc(Uint8List data, String passphrase) {
    ...
    final decrypted = _doDecrypt(ciphertext, iv, tag, passphrase);
